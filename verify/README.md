...
| Registry | Package |
|---|---|
| npm | `@particle-academy/google-slides-js` (+ `@particle-academy/google-slides-ui`, resolved transitively) |
...
npm install @particle-academy/google-slides-js @particle-academy/fancy-flow
