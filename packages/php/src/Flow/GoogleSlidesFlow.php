 ...
 */
/**
 * Every Google Slides node executor — the PHP twin of
 * `GOOGLE_SLIDES_RUNNABLE_KINDS` in @particle-academy/google-slides-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `GoogleSlidesFlow::register($kinds, $executors)` — one call, no directory
 * scan.
